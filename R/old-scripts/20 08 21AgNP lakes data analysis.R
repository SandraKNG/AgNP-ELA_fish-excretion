  ...
  # testing Generalized Linear Models with Mass and Gamma distribution
  ...
  glm.Nxnorm_emmeans_CI <- glm.Nxnorm_emmeans %>% confint()
  U <- glm.Nxnorm_emmeans_CI %>% group_by(Lake) 
  L <- glm.Nxnorm_emmeans_CI$asymp.LCL
