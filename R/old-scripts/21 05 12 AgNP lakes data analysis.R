  ...
  eff_sizeNxp <- ggplot(eff_sizeNxdf,
    ...
    annotate("text", x = 2.2, y = 0, label = 'B', 
             size = 7, fontface = 'bold')
  eff_sizeNxp
  
  windows(width = 20, height = 14)
  ggarrange(Nexcrp, eff_sizeNxp, nrow = 2, heights = c(1.8, 1),
  ...
  eff_sizePxp <- ggplot(eff_sizePxdf,
    ...
    theme(text = element_text( family = "Tahoma"),
          ...
          legend.position = 'right') +
    scale_y_continuous(name = 'Effect size') +
    annotate("text", x = 3, y = 0, label = 'B', 
             size = 7, fontface = 'bold')
  eff_sizePxp
    
  windows(width = 20, height = 14)
  ggarrange(Pexcrp, eff_sizePxp, nrow = 2, heights = c(1.8, 1),
            legend = 'top', common.legend = T, align = 'v')
  ...
  Pexcrmod.p <- ggplot(Pmod,aes(x = Ingestion.rate, y = ModP.excretion,
    ...
    geom_point() +
    geom_point(aes(x = Ingestion.rate, y = MeasP.excretion,
